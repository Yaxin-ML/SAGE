...
class AlgorithmBase:
    ...
    def __init__(self, args, net_builder, tb_log=None, logger=None, **kwargs):
        ...
        # build dataset
        self.dataset_dict, self.lb_count_message = self.set_dataset()
    ...
    def set_dataset(self):
        ...
        dataset_dict, lb_count_message = get_dataset(self.args, self.args.dataset)
    ...
    def set_data_loader(self):
        ...
        loader_dict['eval_lb'] = get_data_loader(self.args,
                                                 self.dataset_dict['train_lb'],
    ...
    def train_step(self, idx_lb, x_lb_w, x_lb_s, y_lb, idx_ulb, x_ulb_w, x_ulb_s, y_ulb):
        """
