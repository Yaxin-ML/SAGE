...
ALL_MODULES = [
    ...
    ('semilearn.algorithms', ['fixmatch','distillfixmatch']),
    ('semilearn.imb_algorithms', ['supervise','long_tail_la','fixmatch','freematch','softmatch','cgmatch','acr','simpro','cdmad','adello','metaexpert','cpg','sage'])
]
